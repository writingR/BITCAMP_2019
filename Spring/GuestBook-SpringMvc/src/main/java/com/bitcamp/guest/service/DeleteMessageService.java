...
public class DeleteMessageService implements GuestBookService {
	...
	public int deleteMessage(int message_id, String password) throws SQLException, MessageNotFoundException, InvalidMessagePasswordException {
		...
		try {
			...
			if(message == null) {
				throw new MessageNotFoundException("메시지가 존재하지 않습니다. : " + message_id);
			...
			resultCnt = dao.deleteMessage(conn, message_id);
